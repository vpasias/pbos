...
Set Up Lab
    ...
    FOR     ${vm}   IN  @{VMS}
        ...
        ${rc} =     Run And Return Rc
        ...     sudo virt-resize --expand /dev/sda1 ${SRC_DIR}/${IMG} ${DST_DIR}/${vm}.qcow2
        Should Be Equal As Integers     ${rc}   0
...
Create Interfaces
    ...
    FOR     ${br}   IN         @{ifaces}
        ...
        Run     virsh attach-interface --domain ${vm} --type network --source ${br} --model virtio --mac ${mac} --config --live
